# -*- coding: utf-8 -*-
"""
Created on Wed May 21 17:09:55 2025
...
def load_test_data(data_path, seq_length):
    """加载并预处理测试数据"""
    df = pd.read_csv(data_path, usecols=range(2, 16), header=0)
...
def main():
    ...
    time.sleep(2)
    # 后处理
    input_file = RESULTS_FILENAME
    dataprocess(exp_path, input_file)
